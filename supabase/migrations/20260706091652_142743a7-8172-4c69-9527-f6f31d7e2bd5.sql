...
-- Initialize stock for existing products that are marked in_stock
UPDATE public.products SET stock_qty = 10 WHERE in_stock = true AND stock_qty = 0;
...
BEGIN
  ...
  -- Decrement stock and auto-flip in_stock when depleted

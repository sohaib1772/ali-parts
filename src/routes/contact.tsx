  ...
  return (
    <PageShell title="اتصل بنا">
      <div className="px-4 pt-4 space-y-3">
        <a href={whatsappLink("مرحباً")} target="_blank" rel="noreferrer" className="flex items-center gap-3 bg-card rounded-2xl border border-border p-4 shadow-card hover:shadow-luxe transition">
          ...
          <div>
            ...
            <div className="text-xs text-muted-foreground" dir="ltr">+{WHATSAPP_NUMBER}</div>
          </div>
        </a>
        <a href={`tel:+${WHATSAPP_NUMBER}`} className="flex items-center gap-3 bg-card rounded-2xl border border-border p-4 shadow-card">
